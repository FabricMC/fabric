...
public class TransferTestInitializer implements ModInitializer {
	...
	public void onInitialize() {
		...
		Registry.register(Registries.ITEM, Identifier.method_60655(MOD_ID, "extract_stick"), EXTRACT_STICK);

		FLUID_CHUTE_TYPE = FabricBlockEntityTypeBuilder.create(FluidChuteBlockEntity::new, FLUID_CHUTE).build();
		Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.method_60655(MOD_ID, "fluid_chute"), FLUID_CHUTE_TYPE);
	...
	private static void registerBlock(Block block, String name) {
		Identifier id = Identifier.method_60655(MOD_ID, name);
