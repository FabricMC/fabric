...
public final class FluidStorage {
	...
	public static final BlockApiLookup<Storage<FluidVariant>, @Nullable Direction> SIDED =
			BlockApiLookup.get(Identifier.method_60655("fabric", "sided_fluid_storage"), Storage.asClass(), Direction.class);
	...
	public static final ItemApiLookup<Storage<FluidVariant>, ContainerItemContext> ITEM =
			ItemApiLookup.get(Identifier.method_60655("fabric", "fluid_storage"), Storage.asClass(), ContainerItemContext.class);
