...
public class DefaultResourceConditionsTest {
	...
	private static final RegistryKey<? extends Registry<Object>> UNKNOWN_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.method_60655(TESTMOD_ID, "unknown_registry"));
	private static final Identifier UNKNOWN_ENTRY_ID = Identifier.method_60655(TESTMOD_ID, "tiny_potato");
	...
	public void featuresEnabled(TestContext context) {
		...
		Identifier unknownId = Identifier.method_60655(TESTMOD_ID, "unknown_feature_to_test_condition");
