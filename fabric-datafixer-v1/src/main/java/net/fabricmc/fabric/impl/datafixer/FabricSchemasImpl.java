...
import net.fabricmc.fabric.datafixer.mixin.Schema704Access;
import net.fabricmc.fabric.datafixer.mixin.Schema705Access;
...
public class FabricSchemasImpl {
    ...
    public static class FabricSchema extends Schema {
        ...
        public void registerTypes(final Schema schema_1, final Map<String, Supplier<TypeTemplate>> entityTypes, final Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
            ...
            schema_1.registerType(false, TypeReferences.PLAYER, () -> {
                return DSL.optionalFields("Inventory", DSL.list(TypeReferences.ITEM_STACK.in(schema_1)), "EnderItems", DSL.list(TypeReferences.ITEM_STACK.in(schema_1)));
            });
            ...
            schema_1.registerType(true, TypeReferences.ENTITY_TREE, () -> {
                return DSL.optionalFields("Riding", TypeReferences.ENTITY_TREE.in(schema_1), TypeReferences.ENTITY.in(schema_1));
            });
