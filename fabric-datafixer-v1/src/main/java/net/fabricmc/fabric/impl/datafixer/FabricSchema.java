...
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema100Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema1460Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema1470Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema1800Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema1801Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema1904Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema1906Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema1920Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema1928Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema1931Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema501Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema700Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema701Access;
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema702Access;
...
import net.fabricmc.fabric.datafixer.mixin.accessor.Schema808Access;
 ...
 * <p>Please note when updating the API when a new Schema is added, any new registeredTypes in {@link #registerTypes(Schema, Map, Map)} should be added with a comment above it specifying the Schema Version name.</p>
 */
public class FabricSchema extends Schema {
    ...
    public void registerTypes(final Schema schema, final Map<String, Supplier<TypeTemplate>> entityTypes, final Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
        ...
        schema.registerType(false, TypeReferences.PLAYER, () -> {
            return DSL.optionalFields("Inventory", DSL.list(TypeReferences.ITEM_STACK.in(schema)), "EnderItems",
        ...
        schema.registerType(true, TypeReferences.ENTITY_TREE, () -> {
            return DSL.optionalFields("Riding", TypeReferences.ENTITY_TREE.in(schema),
        ...
        schema.registerType(true, TypeReferences.ENTITY_TREE, () -> {
            return DSL.optionalFields("Passengers", DSL.list(TypeReferences.ENTITY_TREE.in(schema)),
                    TypeReferences.ENTITY.in(schema));
        });
