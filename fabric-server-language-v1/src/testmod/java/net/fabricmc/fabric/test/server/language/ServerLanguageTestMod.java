...
package net.fabricmc.fabric.test.server.language;
...
public class ServerLanguageTestMod implements DedicatedServerModInitializer {
	private static final String MOD_ID = "fabric-server-language-v1-testmod";
	...
	public void onInitializeServer() {
		...
		// And one minecraft key that this mod should overwrite
		TranslatableText wings = new TranslatableText("item.minecraft.elytra");
		...
		// The collision resolution logic should allow mods to overwrite minecraft keys
		logTestResult(
				wings.getString().equals("Wings"),
				"Mod provided translation keys can overwrite minecraft keys",
				wings.getString()
		);
