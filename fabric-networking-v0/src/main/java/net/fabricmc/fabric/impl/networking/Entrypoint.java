...
public final class Entrypoint implements ModInitializer {
	...
	public void onInitialize() {
		ServerPacketChannelCallback.CLIENT_REGISTERED.register((handler, sender, channels) -> {
			C2SPacketTypeCallback.REGISTERED.invoker().accept(handler.player, channels);
		});
		ServerPacketChannelCallback.CLIENT_UNREGISTERED.register((handler, sender, channels) -> {
