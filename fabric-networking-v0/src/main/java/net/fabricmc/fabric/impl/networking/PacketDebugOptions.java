...
public final class PacketDebugOptions {
	...
	public static final boolean WARN_UNREGISTERED_PACKETS = System.getProperty("fabric.networking.warnUnregisteredPackets", Boolean.toString(PacketRegistryImpl.LOGGER.isDebugEnabled())).equalsIgnoreCase("true");
