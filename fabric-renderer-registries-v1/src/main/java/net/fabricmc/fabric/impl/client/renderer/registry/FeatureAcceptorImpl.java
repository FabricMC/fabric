...
public final class FeatureAcceptorImpl implements RegisterFeatureRendererCallback.FeatureAcceptor {
	private final Function<FeatureRenderer<?, ?>, Boolean> delegate;

	public FeatureAcceptorImpl(Function<FeatureRenderer<?, ?>, Boolean> delegate) {
