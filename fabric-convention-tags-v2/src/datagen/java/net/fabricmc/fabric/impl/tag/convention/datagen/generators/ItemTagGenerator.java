...
public final class ItemTagGenerator extends FabricTagProvider.ItemTagProvider {
	...
	private void generateBackwardsCompatTags() {
		...
		getOrCreateTagBuilder(ConventionalItemTags.WOODEN_BARRELS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "wooden_barrels"));
		getOrCreateTagBuilder(ConventionalItemTags.WOODEN_CHESTS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "wooden_chests"));
		getOrCreateTagBuilder(ConventionalItemTags.BLACK_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "black_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.BLUE_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "blue_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.BROWN_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "brown_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.GREEN_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "green_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.RED_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "red_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.WHITE_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "white_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.YELLOW_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "yellow_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.LIGHT_BLUE_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "light_blue_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.LIGHT_GRAY_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "light_gray_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.LIME_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "lime_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.MAGENTA_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "magenta_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.ORANGE_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "orange_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.PINK_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "pink_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.CYAN_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "cyan_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.GRAY_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "gray_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.PURPLE_DYES).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "purple_dyes"));
		getOrCreateTagBuilder(ConventionalItemTags.IRON_RAW_MATERIALS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "raw_iron_ores"));
		getOrCreateTagBuilder(ConventionalItemTags.COPPER_RAW_MATERIALS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "raw_copper_ores"));
		getOrCreateTagBuilder(ConventionalItemTags.GOLD_RAW_MATERIALS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "raw_gold_ores"));
		getOrCreateTagBuilder(ConventionalItemTags.GLOWSTONE_DUSTS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "glowstone_dusts"));
		getOrCreateTagBuilder(ConventionalItemTags.REDSTONE_DUSTS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "redstone_dusts"));
		getOrCreateTagBuilder(ConventionalItemTags.DIAMOND_GEMS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "diamonds"));
		getOrCreateTagBuilder(ConventionalItemTags.LAPIS_GEMS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "lapis"));
		getOrCreateTagBuilder(ConventionalItemTags.EMERALD_GEMS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "emeralds"));
		getOrCreateTagBuilder(ConventionalItemTags.QUARTZ_GEMS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "quartz"));
		getOrCreateTagBuilder(ConventionalItemTags.SHEARS_TOOLS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "shears"));
		getOrCreateTagBuilder(ConventionalItemTags.SPEARS_TOOLS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "spears"));
		getOrCreateTagBuilder(ConventionalItemTags.BOWS_TOOLS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "bows"));
		getOrCreateTagBuilder(ConventionalItemTags.SHIELDS_TOOLS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "shields"));
		getOrCreateTagBuilder(ConventionalItemTags.STRINGS).addOptionalTag(Identifier.method_60655(TagUtil.C_TAG_NAMESPACE, "string"));
	}
}
