...
public abstract class ThreadedAnvilChunkStorageMixin implements EntityTrackerStorageAccessor {
	@Shadow
	@Final
	private Int2ObjectMap<EntityTrackerMixin> entityTrackers;

	@Override
	public Collection<ServerPlayerEntity> fabric_getTrackingPlayers(Entity entity) {
		EntityTrackerMixin accessor = entityTrackers.get(entity.getEntityId());
		return accessor != null ? accessor.getPlayersTracking() : Collections.emptySet();
	}
}
