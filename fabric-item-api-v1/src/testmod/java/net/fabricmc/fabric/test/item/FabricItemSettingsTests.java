...
public class FabricItemSettingsTests implements ModInitializer {
	...
	public void onInitialize() {
		...
		Registry.register(Registry.ITEM, new Identifier("fabric-item-api-v1-testmod", "custom_bundle_occupancy_item"), new Item(new FabricItemSettings().group(ItemGroup.MISC).maxCount(32).bundleOccupancy(32)));
