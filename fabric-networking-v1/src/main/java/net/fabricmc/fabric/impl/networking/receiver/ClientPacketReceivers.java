...
public final class ClientPacketReceivers {
	public static final SimplePacketReceiverRegistry<ClientPlayPacketContext> PLAY = new ClientPlayPacketReceiverRegistry();
	public static final SimplePacketReceiverRegistry<ClientLoginQueryPacketContext> LOGIN_QUERY = new ThreadSafePacketReceiverRegistry<>();
