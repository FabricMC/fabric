...
/**
 * This is a simple class to store all the keyCodes for keyboard input.
 * This allows an easier understanding of what key you are selecting.
 */
public class KeyCode
{
	...
	public static final int KEY_NUM_0 = 320;
	public static final int KEY_NUM_1 = 321;
	public static final int KEY_NUM_2 = 322;
	public static final int KEY_NUM_3 = 323;
	public static final int KEY_NUM_4 = 324;
	public static final int KEY_NUM_5 = 325;
	public static final int KEY_NUM_6 = 326;
	public static final int KEY_NUM_7 = 327;
	public static final int KEY_NUM_8 = 328;
	public static final int KEY_NUM_9 = 329;
	public static final int KEY_NUM_ADD = 329;
	public static final int KEY_NUM_ENTER = 335;
	public static final int KEY_NUM_EQUAL = 336;
	public static final int KEY_NUM_MULTIPLY = 332;
	...
	public static final int KEY_LEFT_BRACKET = 93;
	public static final int KEY_MINUS = 45;
	public static final int KEY_PERIOD = 46;
	public static final int KEY_RIGHT_BACKET = 93;
	...
	public static final int KEY_LEFT_WIN = 343;//Some keyboards have a left and right Windows key.
	...
	public static final int KEY_RIGHT_WIN = 347;//Some keyboards have a left and right Windows key.
	public static final int KEY_WINDOWS = 343;//Sort of General Windows Button.
