 ...
 * via {@link #bakeSprite(QuadMaker, int, Sprite, int)}. Also used by the API
 * itself to implement automatic block-breaking models for enhanced models.
 */
public class TextureHelper {
    /**
     * Causes texture to appear with no rotation.
     * Pass in bakeFlags parameter to {@link #bakeSprite(QuadMaker, int, Sprite, int)}.
     */
     ...
     * Pass in bakeFlags parameter to {@link #bakeSprite(QuadMaker, int, Sprite, int)}.<p>
     * 
     ...
     */
    public static void bakeSprite(QuadMaker quad, int spriteIndex, Sprite sprite, int bakeFlags) {
     ...
     */
    private static void interpolate(QuadMaker q, int spriteIndex, Sprite sprite) {
    ...
    private static interface VertexModifier {
        void apply(QuadMaker quad, int vertexIndex, int spriteIndex);
    }
    
    private static void applyModifier(QuadMaker quad, int spriteIndex, VertexModifier modifier) {
        for(int i = 0; i < 4; i++) {
