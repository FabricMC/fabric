 ...
 * 
 * <li>{@link QuadPackager} For models that need to generate vertex data on the fly.
 ...
 */
public interface DynamicVertexConsumer extends FastVertexConsumer, QuadPackager, StandardQuadConsumer {
}
