 ...
 * quad rendering characteristics to a {@link ModelVertexConsumer}.<p>
 *
...
public interface ModelMaterialBuilder {
     ...
     * by sending a colorIndex value of -1 to the {@link ModelVertexConsumer}.
     */
    ...
    /**
     * When true, brightness value provided via {@link ModelVertexConsumer#brightness(int)}
