...
abstract class ChunkSerializerMixin {
	...
	// TODO 24w33a - This method no longer passes ServerWorld or Chunk
	/*@Inject(
			at = @At("RETURN"),
			method = "serialize"
	)
	private void writeChunkAttachments(ServerWorld world, Chunk chunk, CallbackInfoReturnable<NbtCompound> cir) {
