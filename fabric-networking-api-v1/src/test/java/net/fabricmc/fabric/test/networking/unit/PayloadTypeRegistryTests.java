...
public class PayloadTypeRegistryTests {
	...
	private record C2SPlayPayload(String value) implements CustomPayload {
		public static final CustomPayload.Id<C2SPlayPayload> ID = new Id<>(Identifier.method_60654("fabric:c2s_play"));
	...
	private record S2CPlayPayload(String value) implements CustomPayload {
		public static final CustomPayload.Id<S2CPlayPayload> ID = new Id<>(Identifier.method_60654("fabric:s2c_play"));
	...
	private record C2SConfigPayload(String value) implements CustomPayload {
		public static final CustomPayload.Id<C2SConfigPayload> ID = new Id<>(Identifier.method_60654("fabric:c2s_config"));
	...
	private record S2CConfigPayload(String value) implements CustomPayload {
		public static final CustomPayload.Id<S2CConfigPayload> ID = new Id<>(Identifier.method_60654("fabric:s2c_config"));
