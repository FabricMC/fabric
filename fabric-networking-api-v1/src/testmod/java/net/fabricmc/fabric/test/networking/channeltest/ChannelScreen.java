...
final class ChannelScreen extends Screen {
	...
	protected void init() {
		...
		this.channelList = new ChannelList(this.minecraft, this.width, this.height - 60, 30, this.height - 30, this.font.fontHeight + 2);
		this.children.add(this.channelList);
	}
	...
	public void render(int mouseX, int mouseY, float delta) {
		...
		if (this.s2cButton.active && this.c2sButton.active) {
			...
			final int textWidth = this.font.getStringWidth(clickMe);
