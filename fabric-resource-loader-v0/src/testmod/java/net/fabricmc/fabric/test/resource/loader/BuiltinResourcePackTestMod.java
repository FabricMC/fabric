...
public class BuiltinResourcePackTestMod implements ModInitializer {
	...
	public void onInitialize() {
		...
		FabricLoader.getInstance().getModContainer(MODID)
				.map(container -> ResourceManagerHelper.registerBuiltinResourcePack(Identifier.method_60655(MODID, "test"),
		...
		FabricLoader.getInstance().getModContainer(MODID)
				.map(container -> ResourceManagerHelper.registerBuiltinResourcePack(Identifier.method_60655(MODID, "test2"),
