...
public interface ResourceManagerHelper {
	 ...
	 * @param id             the identifier of the resource pack
	 * @param container      the mod container
	 * @param name           the name of the resource pack, should include mod name for clarity
	 * @param activationType the activation type of the resource pack
	 * @return {@code true} if successfully registered the resource pack, else {@code false}
	 */
	static boolean registerBuiltinResourcePack(Identifier id, ModContainer container, String name, ResourcePackActivationType activationType) {
		return ResourceManagerHelperImpl.registerBuiltinResourcePack(id, "resourcepacks/" + id.getPath(), container, name, activationType);
	}
	 ...
	 * @param container      the mod container
	 * @param name           the name of the resource pack, should include mod name for clarity
	 * @param displayName    the display name of the resource pack, used for the Select Resource Pack screen
	 * @param activationType the activation type of the resource pack
	 * @return {@code true} if successfully registered the resource pack, else {@code false}
	 */
	static boolean registerBuiltinResourcePack(Identifier id, ModContainer container, String name, Text displayName, ResourcePackActivationType activationType) {
		return ResourceManagerHelperImpl.registerBuiltinResourcePack(id, "resourcepacks/" + id.getPath(), container, name, displayName, activationType);
	}
