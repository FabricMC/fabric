...
public final class PlayerStream {
	 ...
	 */
	public static Collection<ServerPlayerEntity> world(World world) {
	 ...
	 * @throws IllegalArgumentException if the world is not a server world
	 */
	public static Stream<ServerPlayerEntity> watching(World world, ChunkPos pos) {
	 ...
	 * @throws IllegalArgumentException if the world is not a server world
	 */
	public static Stream<ServerPlayerEntity> watching(World world, BlockPos pos) {
	 ...
	 * @throws IllegalArgumentException if the world is not a server world
	 */
	public static Stream<ServerPlayerEntity> around(World world, Vec3d pos, double radius) {
	 ...
	 * @throws IllegalArgumentException if the world is not a server world
	 */
	public static Stream<ServerPlayerEntity> around(World world, Vec3i pos, double radius) {
		double radiusSq = radius * radius;
