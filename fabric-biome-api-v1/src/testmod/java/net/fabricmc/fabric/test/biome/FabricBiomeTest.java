...
public class FabricBiomeTest implements ModInitializer {
	...
	public static final RegistryKey<Biome> TEST_CRIMSON_FOREST = RegistryKey.of(class_7924.BIOME_WORLDGEN, new Identifier(MOD_ID, "test_crimson_forest"));
	public static final RegistryKey<Biome> CUSTOM_PLAINS = RegistryKey.of(class_7924.BIOME_WORLDGEN, new Identifier(MOD_ID, "custom_plains"));
	public static final RegistryKey<Biome> TEST_END_HIGHLANDS = RegistryKey.of(class_7924.BIOME_WORLDGEN, new Identifier(MOD_ID, "test_end_highlands"));
	public static final RegistryKey<Biome> TEST_END_MIDLANDS = RegistryKey.of(class_7924.BIOME_WORLDGEN, new Identifier(MOD_ID, "test_end_midlands"));
	public static final RegistryKey<Biome> TEST_END_BARRRENS = RegistryKey.of(class_7924.BIOME_WORLDGEN, new Identifier(MOD_ID, "test_end_barrens"));

	public static final RegistryKey<ConfiguredFeature<?, ?>> COMMON_DESERT_WELL = RegistryKey.of(
			class_7924.CONFIGURED_FEATURE_WORLDGEN,
	...
	public static final RegistryKey<PlacedFeature> PLACED_COMMON_DESERT_WELL = RegistryKey.of(
			class_7924.PLACED_FEATURE_WORLDGEN,
			new Identifier(FabricBiomeTest.MOD_ID, "fab_desert_well")
	);
	...
	public void onInitialize() {
		...
		BiomeModifications.create(new Identifier("fabric:test_mod"))
				...
				.add(ModificationPhase.ADDITIONS,
						BiomeSelectors.tag(TagKey.of(class_7924.BIOME_WORLDGEN, new Identifier(MOD_ID, "tag_selector_test"))),
		...
		BiomeModifications.addFeature(
				...
				RegistryKey.of(class_7924.PLACED_FEATURE_WORLDGEN, new Identifier(MOD_ID, "concrete_pile"))
		);

		// Make sure data packs can define biomes
		NetherBiomes.addNetherBiome(
				RegistryKey.of(class_7924.BIOME_WORLDGEN, new Identifier(MOD_ID, "example_biome")),
