...
public final class WeightedBiomePicker {
	...
	void addBiome(final RegistryEntry<Biome> biome, final double weight) {
		currentTotal += weight;
	...
	public RegistryEntry<Biome> pickFromNoise(PerlinNoiseSampler sampler, double x, double y, double z) {
