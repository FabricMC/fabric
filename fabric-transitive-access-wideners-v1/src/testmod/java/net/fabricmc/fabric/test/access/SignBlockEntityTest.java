...
public final class SignBlockEntityTest implements ModInitializer {
	...
	public void onInitialize() {
		Registry.register(Registries.BLOCK, Identifier.method_60655(MOD_ID, "test_sign"), TEST_SIGN);
		Registry.register(Registries.BLOCK, Identifier.method_60655(MOD_ID, "test_wall_sign"), TEST_WALL_SIGN);
		Registry.register(Registries.ITEM, Identifier.method_60655(MOD_ID, "test_sign"), TEST_SIGN_ITEM);
		Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.method_60655(MOD_ID, "test_sign"), TEST_SIGN_BLOCK_ENTITY);
	}
