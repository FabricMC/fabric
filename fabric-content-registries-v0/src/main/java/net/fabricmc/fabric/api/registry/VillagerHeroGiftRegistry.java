...
public interface VillagerHeroGiftRegistry {
	...
	void add(VillagerProfession profession, Identifier lootTable);

	Identifier remove(VillagerProfession profession);

	Identifier get(VillagerProfession profession);
}
