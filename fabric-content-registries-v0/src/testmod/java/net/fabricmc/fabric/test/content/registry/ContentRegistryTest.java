...
public final class ContentRegistryTest implements ModInitializer {
	...
	public static final Identifier TEST_EVENT_ID = Identifier.method_60655("fabric-content-registries-v0-testmod", "test_event");
	...
	public void onInitialize() {
		...
		VillagerInteractionRegistries.registerGiftLootTable(VillagerProfession.NITWIT, RegistryKey.of(RegistryKeys.LOOT_TABLE, Identifier.method_60656("fake_loot_table")));
		...
		Registry.register(Registries.ITEM, Identifier.method_60655("fabric-content-registries-v0-testmod", "dirty_potion"),
				dirtyPotion);
