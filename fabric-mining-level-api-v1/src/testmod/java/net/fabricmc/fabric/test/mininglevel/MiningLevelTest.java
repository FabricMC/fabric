...
public final class MiningLevelTest implements ModInitializer {
	...
	private static void test() {
		...
		checkMiningSpeed(NEEDS_SHEARS, Items.SHEARS, NETHERITE_SHEARS, Items.STICK);
		checkMiningSpeed(NEEDS_SHEARS_SLOW, Items.SHEARS, NETHERITE_SHEARS, Items.STICK);
		checkMiningSpeed(NEEDS_SHEARS_FAST, Items.SHEARS, NETHERITE_SHEARS, Items.STICK);
