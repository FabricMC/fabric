...
public class ScreenHandlerTest implements ModInitializer {
	...
	public static final Item BAG = new BagItem(new Item.Settings().maxCount(1).method_63686(BAG_KEY));
	public static final RegistryKey<Item> POSITIONED_BAG_KEY = RegistryKey.of(RegistryKeys.ITEM, id("positioned_bag"));
	public static final Item POSITIONED_BAG = new PositionedBagItem(new Item.Settings().maxCount(1).method_63686(POSITIONED_BAG_KEY));
	...
	public static final Item BOX_ITEM = new BlockItem(BOX, new Item.Settings().method_63686(RegistryKey.of(RegistryKeys.ITEM, BOX_KEY.getValue())));
