...
public abstract class CustomFluid extends FlowableFluid {
	...
	public Fluid getFlowing() {
		return FabricFluidApiTestMod.CUSTOM_FLOWING;
	}

	@Override
	public Fluid getStill() {
		return FabricFluidApiTestMod.CUSTOM;
	}
	...
	public BlockState toBlockState(FluidState state) {
		return FabricFluidApiTestMod.CUSTOM_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
	}

	@Override
	public boolean matchesType(Fluid fluid) {
		return fluid == FabricFluidApiTestMod.CUSTOM || fluid == FabricFluidApiTestMod.CUSTOM_FLOWING;
	}
