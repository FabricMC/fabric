...
public class TestFluids {
	...
	public static final FluidBlock NO_OVERLAY_BLOCK = Registry.register(Registry.BLOCK, "fabric-rendering-fluids-v1-testmod:no_overlay", new FabricFluidBlock(NO_OVERLAY, AbstractBlock.Settings.copy(Blocks.WATER)));
	...
	public static final FluidBlock OVERLAY_BLOCK = Registry.register(Registry.BLOCK, "fabric-rendering-fluids-v1-testmod:overlay", new FabricFluidBlock(OVERLAY, AbstractBlock.Settings.copy(Blocks.WATER)));
	...
	public static final FluidBlock UNREGISTERED_BLOCK = Registry.register(Registry.BLOCK, "fabric-rendering-fluids-v1-testmod:unregistered", new FabricFluidBlock(UNREGISTERED, AbstractBlock.Settings.copy(Blocks.WATER)));
	...
	public static final FluidBlock CUSTOM_BLOCK = Registry.register(Registry.BLOCK, "fabric-rendering-fluids-v1-testmod:custom", new FabricFluidBlock(CUSTOM, AbstractBlock.Settings.copy(Blocks.WATER)));
}
