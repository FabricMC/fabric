...
public final class TradeOfferHelper {
	...
	public interface WanderingTraderOffersBuilder {
		 ...
		 * for emeralds.
		 */
		Identifier BUY_ITEMS_POOL = Identifier.method_60656("buy_items");
		/**
		 ...
		 */
		Identifier SELL_SPECIAL_ITEMS_POOL = Identifier.method_60656("sell_special_items");
		/**
		 ...
		 */
		Identifier SELL_COMMON_ITEMS_POOL = Identifier.method_60656("sell_common_items");
