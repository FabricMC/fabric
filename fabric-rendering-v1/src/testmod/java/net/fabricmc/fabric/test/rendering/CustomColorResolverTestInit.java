...
public class CustomColorResolverTestInit implements ModInitializer {
	...
	public static final Item CUSTOM_COLOR_BLOCK_ITEM = new BlockItem(CUSTOM_COLOR_BLOCK, new Item.Settings().method_63686(RegistryKey.of(RegistryKeys.ITEM, KEY.getValue())));
