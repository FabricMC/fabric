...
public class TooltipComponentTestInit implements ModInitializer {
	...
	public static RegistryEntry<ArmorMaterial> TEST_ARMOR_MATERIAL = Registry.registerReference(Registries.ARMOR_MATERIAL, Identifier.method_60655("fabric-rendering-v1-testmod", "test_material"), createTestArmorMaterial());
	public static Item CUSTOM_ARMOR_ITEM = new ArmorItem(TEST_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings());

	@Override
	public void onInitialize() {
		Registry.register(Registries.ITEM, Identifier.method_60655("fabric-rendering-v1-testmod", "custom_tooltip"), CUSTOM_TOOLTIP_ITEM);
		Registry.register(Registries.ITEM, Identifier.method_60655("fabric-rendering-v1-testmod", "test_chest"), CUSTOM_ARMOR_ITEM);
	}
	...
	private static ArmorMaterial createTestArmorMaterial() {
		return new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), (map) -> {
			...
			List.of(new ArmorMaterial.Layer(Identifier.method_60655("fabric-rendering-v1-testmod", "test_material"))),
			0,
			0
		);
	}
