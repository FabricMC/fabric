...
public class TagUtilTest implements ModInitializer {
	...
	public void onInitialize() {
		ServerLifecycleEvents.SERVER_STARTED.register(server -> {
			...
			if (TagUtil.isIn(ConventionalBiomeTags.IN_OVERWORLD, server.getRegistryManager().get(class_7924.BIOME_WORLDGEN).get(BiomeKeys.BADLANDS))) {
			...
			if (!TagUtil.isIn(server.getRegistryManager(), ConventionalBiomeTags.IN_OVERWORLD, server.getRegistryManager().get(class_7924.BIOME_WORLDGEN).get(BiomeKeys.BADLANDS))) {
