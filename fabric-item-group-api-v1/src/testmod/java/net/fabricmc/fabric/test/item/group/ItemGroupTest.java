...
public class ItemGroupTest implements ModInitializer {
	...
	public void onInitialize() {
		...
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS).register((enabledFeatures, content) -> {
		...
		ItemGroupEvents.MODIFY_ENTRIES_ALL.register((group, enabledFeatures, content) -> {
