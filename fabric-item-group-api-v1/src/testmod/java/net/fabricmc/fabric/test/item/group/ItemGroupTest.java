...
public class ItemGroupTest implements ModInitializer {
	...
	private static final RegistryKey<ItemGroup> ITEM_GROUP = RegistryKey.of(RegistryKeys.ITEM_GROUP, Identifier.method_60655(MOD_ID, "test_group"));

	@Override
	public void onInitialize() {
		TEST_ITEM = Registry.register(Registries.ITEM, Identifier.method_60655("fabric-item-groups-v0-testmod", "item_test_group"), new Item(new Item.Settings()));
		...
		for (int j = 0; j < 20; j++) {
			Registry.register(
					...
					Identifier.method_60655(MOD_ID, "empty_group_" + j),
		...
		for (int i = 0; i < 100; i++) {
			...
			Registry.register(Registries.ITEM_GROUP, Identifier.method_60655(MOD_ID, "test_group_" + i), FabricItemGroup.builder()
