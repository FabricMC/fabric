...
public class ItemGroupTest implements ModInitializer {
	...
	private static final RegistryKey<ItemGroup> ITEM_GROUP = RegistryKey.of(RegistryKeys.CREATIVE_MODE_TAB, new Identifier(MOD_ID, "test_group"));
	...
	public void onInitialize() {
		...
		Registry.register(Registries.field_44687, ITEM_GROUP, FabricItemGroup.builder()
		...
		for (int i = 0; i < 100; i++) {
			...
			Registry.register(Registries.field_44687, new Identifier(MOD_ID, "test_group_" + i), FabricItemGroup.builder()
