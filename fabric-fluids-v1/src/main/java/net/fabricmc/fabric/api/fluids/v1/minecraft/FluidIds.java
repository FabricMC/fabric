...
public class FluidIds {
	...
	/**
	 * when dealing with vanilla fluids (or other modded fluids) that don't have a {@link Fluid} class associated with them multiple mods may want to add the fluids, so it's recommended to check if another mod has already beat you to it or not.
	 *
