package net.fabricmc.fabric.api.fluids;
...
import net.fabricmc.fabric.api.fluids.containers.SimpleFluidContainer;
...
public class FluidView {
	...
	/**
	 * merge all the entity and block containers in the given location for the given face
	 * into one fluid container
	 *
