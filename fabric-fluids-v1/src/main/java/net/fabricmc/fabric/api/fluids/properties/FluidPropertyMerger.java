...
import net.fabricmc.fabric.api.fluids.minecraft.properties.CustomPotionColorProperty;
import net.fabricmc.fabric.api.fluids.minecraft.properties.CustomPotionEffectsFluidProperty;
import net.fabricmc.fabric.api.fluids.minecraft.properties.PotionFluidProperty;
...
public class FluidPropertyMerger {
	...
	public FluidPropertyMerger() {
		// todo suspicious stew properties
