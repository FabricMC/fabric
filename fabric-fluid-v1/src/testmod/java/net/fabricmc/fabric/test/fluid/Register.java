...
import net.fabricmc.fabric.test.fluid.blocks.TestTankBlockEntity;
import net.fabricmc.fabric.test.fluid.items.FluidShard;

public class Register {
	private static final String ID = "fabric-fluid-v1-test";
	public static final TestTankBlock BLOCK = Registry.register(Registry.BLOCK, new Identifier(ID, "block"), new TestTankBlock(Block.Settings.of(Material.STONE)));
	public static final BlockEntityType<TestTankBlockEntity> BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(ID, "block_entity"), BlockEntityType.Builder.create(TestTankBlockEntity::new, BLOCK).build(null));
	public static final Item FLUID_SHARD = Registry.register(Registry.ITEM, new Identifier(ID,"fluid_shard"), new FluidShard(new Item.Settings()));
