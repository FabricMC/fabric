...
public final class FluidPropertyMerger {
	...
	private final Map<NbtIdentifier, FluidProperty<Tag>> data = new HashMap<>();

	private FluidPropertyMerger() {
	}

	@SuppressWarnings ("unchecked")
	public <T extends Tag> void register(NbtIdentifier identifier, FluidProperty<T> property) {
		this.data.put(identifier, (FluidProperty<Tag>) property);
	}
