...
public class CustomArgumentTest implements ModInitializer {
	...
	public void onInitialize() {
		ArgumentTypeRegistry.registerArgumentType(Identifier.method_60655("fabric-command-test", "smiley"), SmileyArgumentType.class, ConstantArgumentSerializer.of(SmileyArgumentType::smiley));
